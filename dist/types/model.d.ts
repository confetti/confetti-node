...
export type ContactWebhookEvent = 'contact.created' | 'contact.updated' | 'contact.unsubscribed' | 'contact.deletion-requested' | 'contact.deleted';
export type TicketWebhookEvent = 'ticket.attending' | 'ticket.declined' | 'ticket.invited' | 'ticket.waitlist' | 'ticket.updated' | 'ticket.deleted' | 'ticket.deletion-requested' | 'ticket.unsubscribed';
